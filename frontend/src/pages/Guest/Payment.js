          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-semibold text-yellow-900">
                ⏳ Waiting for the Approval of the Host
              </h3>
              <p className="text-sm text-yellow-700 mt-1">
                Your booking request has been submitted and is pending host approval. You can proceed with payment preparation, but the booking will only be finalized once the host confirms.
              </p>
            </div>
          </div>
        </div>
