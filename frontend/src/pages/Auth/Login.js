      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-sm text-center">
            ...
            <p className="text-xs mt-1">Admin: admin@smartstay.com / password123</p>
            <p className="text-xs">Host: host1@smartstay.com / password123</p>
            <p className="text-xs">Guest: guest1@example.com / password123</p>
          </div>
        </form>
      </div>
    </div>
